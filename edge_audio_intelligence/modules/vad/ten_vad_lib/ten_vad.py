...
class TenVad:
    def __init__(self, hop_size: int = 256, threshold: float = 0.5):
        ...
        if platform.system() == "Linux" and platform.machine() == "x86_64":
            ...
            # Try flat copy (lib/ contents copied directly)
            flat_path = os.path.join(module_dir, "macOS/ten_vad.framework/Versions/A/ten_vad")
            ...
            if os.path.exists(git_path):
                ...
                self.vad_library = CDLL(flat_path)
            else:
                raise FileNotFoundError("Cannot find libten_vad at {} or {} or {}".format(git_path, pip_path, flat_path))
